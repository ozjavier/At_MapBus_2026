...
import { listTemplates, createTemplate, duplicateTemplate } from '../../../../../lib/routeTemplates.js';

const pointSchema = z.object({ lat: z.number(), lng: z.number(), skipStop: z.boolean().optional() });
...
export async function POST(context) {
  ...
  if (body?.sourceRouteId) {
    ...
    const newId = await duplicateTemplate(parsed.data.sourceRouteId, parsed.data);
